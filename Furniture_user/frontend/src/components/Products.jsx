  ...
  return (
    <div className="furniture-section">
      ...
      <div className="hero-section2">
        <h1 className="title4">Explore Our Products</h1>
                ...
                <div className="p-4">
                  ...
                  <div className="flex justify-between mt-4">
                    <button
                      ...
                      className="bg-[#023453] text-white px-3 py-1 rounded hover:bg-[#003366] transition"
                    >
                      View Details
                    </button>
                    <div className="flex space-x-2">
                      <button
                        ...
                        className={`${
                          favorites[product._id] ? "bg-pink-500" : "bg-gray-200"
                        } text-white p-1 rounded hover:bg-pink-600 transition`}
                      >
                        <svg
                      ...
                      <button
                        ...
                        } text-white p-1 rounded transition`}
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className="h-5 w-5"
