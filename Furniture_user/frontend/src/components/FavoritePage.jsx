  ...
  useEffect(() => {
    const fetchFavorites = async () => {
      try {
        ...
        const productsResponse = await fetch('http://localhost:3001/api/favorites', {
          method: 'GET',
          headers: {
  ...
  return (
    <div>
      ...
      <div className="hero-section2">
        <h1 className="title4">Favorites</h1>
                ...
                <div className="p-4">
                  ...
                  <div className="flex justify-between mt-4">
                    <button 
                      ...
                      className="bg-[#004581] text-white px-3 py-1 rounded hover:bg-[#003366] transition"
                    >
                      View Details
                    </button>
